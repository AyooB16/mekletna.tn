...
const validationSchema = Yup.object().shape({
  ...
  subcategory2: Yup.string().required("Ce champ est obligatoire"),
            ...
            <Form id="add-plat">
              ...
              <div>
                <TextField
                  ...
                  onBlur={handleBlur}
                  error={errors.namePlat && touched.namePlat ? true : null}
                  helperText={
                    errors.namePlat && touched.namePlat ? errors.namePlat : null
                  }
                />
                <TextField
                  sx={{ m: 1, width: "30ch" }}
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  error={errors.type && touched.type ? true : null}
              ...
              <div>
                <TextField
                  ...
                  onChange={(e) => {
                    ...
                    values.subcategory = "";
                    setSelectedCategory(
                      categories.find(({ value }) => value === e.target.value)
                    );
                  }}
                  onBlur={handleBlur}
                  error={errors.category && touched.category ? true : null}
                  helperText={
                ...
                {values.category !== "" ? (
                  <TextField
                    ...
                    onBlur={handleBlur}
                    error={
                      errors.subcategory && touched.subcategory ? true : null
                    }
                    helperText={
              ...
              <div>
                {values.subcategory !== "" ? (
                  <TextField
                    ...
                    onBlur={handleBlur}
                    error={
                      errors.subcategory2 && touched.subcategory2 ? true : null
                    }
                    helperText={
                      errors.subcategory2 && touched.subcategory2
                        ? errors.subcategory2
                        : null
                    }
                    select
              ...
              <div>
                <TextField
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  error={errors.nbPersonne && touched.nbPersonne ? true : null}
                  helperText={
                    errors.nbPersonne && touched.nbPersonne
                      ? errors.nbPersonne
                      : null
                  }
                />
                <TextField
                  ...
                  onChange={handleChange}
                  onBlur={handleBlur}
                  error={errors.price && touched.price ? true : null}
                  helperText={
              ...
              <Grid container spacing={2} style={{padding:"16px 0"}}>
                  <TextField
                    ...
                    onBlur={handleBlur}
                    error={
                      errors.descripton && touched.descripton ? true : null
                    }
                    helperText={
